    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-20">
        ...
        <div className="card p-8 border-2 border-accent relative">
          ...
          <div className="mb-6">
            <span className="text-4xl font-bold text-accent">&#8364;{PLANS.premium.price}</span>
            <span className="text-gray-500">/month</span>
          </div>
          <ul className="space-y-3 mb-8">
          ...
          {currentTier === 'premium' ? (
            ...
            <button onClick={() => handleSubscribe('premium')} disabled={loading === 'premium'} className="w-full btn-secondary py-3 disabled:opacity-50">
        ...
        <div className="card p-8 bg-gray-900 text-white">
          ...
          <div className="mb-6">
            <span className="text-4xl font-bold text-gold">&#8364;{PLANS.pro.price}</span>
          ...
          {currentTier === 'pro' ? (
            ...
            <button onClick={() => handleSubscribe('pro')} disabled={loading === 'pro'} className="w-full bg-gold hover:bg-yellow-500 text-gray-900 py-3 rounded-lg font-bold disabled:opacity-50 transition-colors">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="flex gap-4">
            <div className="bg-accent/10 p-3 rounded-lg h-fit"><TrendingUp className="h-6 w-6 text-accent" /></div>
            <div><h3 className="font-bold text-lg mb-1">Earn 3x More</h3><p className="text-gray-600">Priority listings mean more parcel requests and higher earnings per trip.</p></div>
          </div>
          <div className="flex gap-4">
            <div className="bg-accent/10 p-3 rounded-lg h-fit"><Shield className="h-6 w-6 text-accent" /></div>
            <div><h3 className="font-bold text-lg mb-1">Trusted Badge</h3><p className="text-gray-600">Stand out with a verified Premium badge. Senders prefer trusted travelers.</p></div>
          </div>
          <div className="flex gap-4">
            <div className="bg-accent/10 p-3 rounded-lg h-fit"><Zap className="h-6 w-6 text-accent" /></div>
            <div><h3 className="font-bold text-lg mb-1">Lower Fees</h3><p className="text-gray-600">Premium pays 3% escrow fee vs 5%. Pro pays 0%. Keep more of what you earn.</p></div>
          </div>
          <div className="flex gap-4">
            <div className="bg-accent/10 p-3 rounded-lg h-fit"><Star className="h-6 w-6 text-accent" /></div>
            <div><h3 className="font-bold text-lg mb-1">Route Alerts</h3><p className="text-gray-600">Get notified instantly when someone needs a parcel sent on your route.</p></div>
          </div>
        </div>
      </div>
    </div>

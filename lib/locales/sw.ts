...
export const sw: Dict = {
  ...
  pricing: {
    ...
    dismiss: "Funga",
    bandTitle: "Bure sasa. Bei wazi baadaye.",
    bandBadge: "Bure wakati wa uzinduzi",
    bandCell1Label: "Uanachama wa baadaye",
    bandCell1a: "$5/mwezi au $29/mwaka",
    bandCell1b: "Uanachama mmoja kwa safari na vifurushi bila kikomo, pande zote mbili.",
    bandCell2Label: "Ada ya msafiri",
    bandCell2a: "Karibu $45 kwa kilo 5",
    bandCell2b: "Kubalianeni na umlipie msafiri moja kwa moja.",
    bandCell2c: "Kifurushi inachukua 0%.",
    bandCell3Label: "Akiba inayowezekana",
    bandCell3: "$150+ kwa mwaka",
    bandCell3b: "Makadirio ya vifurushi vitano vya kilo 5 yakilinganishwa na bei za kawaida za kampuni.",
    whyCards: [
      {

...
export const fr: Dict = {
  ...
  home: {
    ...
    leaderSaved: (amount: number) =>
      `Record d'économies face aux transporteurs : ${amount} $ par`,
  ...
  roles: {
    ...
    postTripDesc: "Je voyage avec des kilos libres",
    findTraveller: "Trouver un voyageur",
    findTravellerDesc: "Je cherche quelqu'un pour transporter mon colis",
    postParcel: "Envoyer un colis",
    postParcelDesc: "J'ai besoin de faire livrer quelque chose",
    browseParcels: "Colis à transporter",
    browseParcelsDesc: "Je voyage et je veux gagner de l'argent",
  },
  chooser: {
  ...
  pricing: {
    ...
    dismiss: "Fermer",
    bandTitle: "Gratuit aujourd'hui. Des tarifs clairs ensuite.",
    bandBadge: "Gratuit pendant le lancement",
    bandCell1Label: "Futur abonnement",
    bandCell1a: "5 $/mois ou 29 $/an",
    bandCell1b: "Un seul abonnement pour publier voyages et colis sans limite, dans les deux sens.",
    bandCell2Label: "Prix du voyageur",
    bandCell2a: "Environ 45 $ les 5 kg",
    bandCell2b: "Convenez du prix et payez directement le voyageur.",
    bandCell2c: "Kifurushi prend 0 %.",
    bandCell3Label: "Économies potentielles",
    bandCell3: "150 $+ par an",
    bandCell3b: "Estimation pour cinq colis de 5 kg comparés aux tarifs habituels des transporteurs.",
    whyCards: [
      {

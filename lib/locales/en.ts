...
export const en = {
  ...
  home: {
    ...
    leaderSaved: (amount: number) =>
      `Most saved vs courier prices: $${amount} by`,
  ...
  pricing: {
    ...
    dismiss: "Dismiss",
    bandTitle: "Free now. Clear pricing later.",
    bandBadge: "Free during launch",
    bandCell1Label: "Future membership",
    bandCell1a: "$5/month or $29/year",
    bandCell1b: "One membership for unlimited trip and parcel posts in both directions.",
    bandCell2Label: "Traveller fee",
    bandCell2a: "Around $45 per 5 kg",
    bandCell2b: "Agree and pay the traveller directly.",
    bandCell2c: "Kifurushi takes 0%.",
    bandCell3Label: "Potential savings",
    bandCell3: "$150+ per year",
    bandCell3b: "Estimate for five 5 kg parcels compared with typical courier pricing.",
    whyCards: [
      {
